    ...
    Lxa.on('chat-update', async(mek) => {
        try {
            ...
            const costum = (pesan, tipe, target, target2) => {
                Lxa.sendMessage(from, pesan, tipe, {
                    quoted: {
                        key: {
                            fromMe: false,
                            participant: `${target}`,
            ...
            function addMetadata(packname, author) {
                if (!packname) packname = 'uwu';
                if (!author) author = 'нσllσgяαм';
...
‣ Grupo:  *${groupName}*
‣ En línea : *${_registered.length} usuarios*
                ...
                case 'img':
                    ...
                    try {
                        ...
                        Lxa.sendMessage(from, pok, image, {
                            quoted: mek,
                            caption: `Berhasil mengambil gambar : *${tels}*`
                        })
